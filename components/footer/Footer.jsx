  ...
  return (
    <>
      <footer className="overflow-hidden bg-no-repeat bg-cover bg-center bg-gradient-to-r from-[#5665AE] to-[#615AA6] text-white tajawal w-full h-[440px] relative">
        ...
        <div className="max-w-screen-xl  py-16 mx-auto relative z-40 ">
          <div className="grid grid-cols-12 gap-20 lg:grid-cols-12  items-end">
            ...
            <div className="lg:col-span-5 w-full md:col-span-5  col-span-5   ">
              ...
              />
              <br></br>
              <p className="float-right  mt-4 text-sm text-white leading-[36px] text-[17px] font-medium tracking-widest text-end	">

                تواصل مع شركة كَوْدلِي النهارده واستفيد من خدماتهم الممتازة في تصميم وتطوير المواقع والتطبيقات، وتنفيذ الأنظمة المخصصة للشركات، المتاجر، والمطاعم. خلّي فريقنا يساعدك في تحقيق رؤيتك وتحقيق النجاح الرقمي!
              </p>
            </div>
          </div>
        </div>
